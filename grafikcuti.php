...
<div class="wrapper">
    ...
    <h1>Grafik Cuti Karyawan</h1>
    <h4>Hasil Laporan Cuti Karyawan terhadap PT Angin Puting Beliung</h4>
        ...
        const myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [15, 27, 74, 86, 22, 30, 87, 57, 49, 88, 11, 10 ], // Data ini bisa diubah sesuai kebutuhan
                    backgroundColor: [
                        'rgba(255, 99, 132, 0.2)',
                        'rgba(54, 162, 235, 0.2)',
                        'rgba(255, 206, 86, 0.2)'
