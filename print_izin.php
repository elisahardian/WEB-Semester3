...
$stmt2 = $conn->prepare("SELECT tblizin.id_izin, tblizin.idpeg, tblizin.ditetapkan, tblizin.tanggal, tblizin.jam, tblizin.alasan, tblizin.pembuat_surat, tabelpegawai.nama 
                         FROM tblizin
                         JOIN tabelpegawai ON tblizin.idpeg = tabelpegawai.idpeg
                         WHERE tblizin.id_izin = ? LIMIT 1");
...
$pdf->Cell(0, 10, 'Surat izin ini ditujukan kepada :', 0, 1, 'L');
$pdf->Ln(1);
